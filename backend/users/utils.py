...
# A small selection of words for the recovery phrase (BIP39 subset for simplicity in this demo)
# In production, a full 2048 word BIP39 list should be used.
WORD_LIST = [
    ...
    "bar", "barely", "bargain", "barrel", "base", "basic", "basket", "battle", "beach", "beam", "bean", "beauty", 
    ...
    "canyon", "capable", "capital", "captain", "caption", "car", "card", "cargo", "carpet", "carry", "cart", "case", 
    "cash", "casino", "castle", "casual", "cat", "catalog", "catch", "category", "cattle", "caught", "cause", "caution", 
    "cave", "ceiling", "celery", "cement", "census", "century", "cereal", "certain", "chair", "chalk", "champion", "change", 
    "chaos", "chapter", "charge", "chase", "chat", "cheap", "check", "cheese", "chef", "cherry", "chest", "chicken"
]

def generate_mnemonic(length=12):
    """Generates a random recovery phrase of specified length."""
    words = [secrets.choice(WORD_LIST) for _ in range(length)]
    return " ".join(words)
