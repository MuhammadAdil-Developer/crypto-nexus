  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="w-full max-w-3xl max-h-[90vh] bg-slate-900 rounded-lg shadow-2xl flex flex-col overflow-hidden border border-slate-700">
        ...
        {/* Content */}
        <div
          className="flex-1 overflow-y-auto px-6 py-4 bg-slate-900/50"
          ...
          <div className="prose prose-invert max-w-none text-slate-300 text-sm leading-relaxed">
            {activeTab === "rules" && (
              <div>
                ...
                <iframe
                  src="/rules.html"
                  className="w-full h-96 bg-slate-800 rounded border border-slate-700"
                  title="Rules"
                />
              </div>
            )}
        ...
        <div className="border-t border-slate-700 bg-slate-800/50 px-6 py-4 space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            <button
              ...
              className={`flex-1 px-4 py-2 rounded font-medium transition-all flex items-center justify-center gap-2 ${
                allConfirmed
