      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <Button 
            variant="ghost" 
            size="sm" 
            className="md:hidden hover:text-text"
                ...
                <li key={index} className="flex items-center">
                  ...
                  {crumb.href ? (
                    <Link href={crumb.href}>
                      <span className="hover:text-text cursor-pointer">{crumb.label}</span>
                    </Link>
                  ) : (
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link href="/">
            <span className="inline-flex items-center px-3 py-1.5 border border-border text-sm font-medium rounded-md hover:text-text hover:bg-surface-2 cursor-pointer">
