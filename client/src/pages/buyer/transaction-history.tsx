        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-400">Track all your payment activities and transactions</p>
            </div>
          </div>
          <Button 
            variant="outline" 
          ...
          <CardContent className="p-6">
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <Button onClick={() => fetchTransactionHistory(currentPage)} variant="outline">
                  Try Again
                </Button>
              </div>
                ...
                {filteredTransactions.map((transaction) => (
                  <div key={transaction.id} className="bg-gray-800 border border-gray-700 rounded-lg p-6 hover:bg-gray-700 transition-colors">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-4">
                        <div className={`w-12 h-12 rounded-full ${getTypeColor(transaction.type)} flex items-center justify-center`}>
